...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<!-- Logout Button -->	    
		    <form:form action="${contextPath.request.pageContext}/logout" 
	...
	<div class="col-lg-9 col-lg-offset-9" id="container">
		<div id="content">
			...
			<h3 id="header" >Edit General Information</h3>
			
			<div id="separator"></div>
		
			<form:form action="${pageContext.request.contextPath}/update/general" modelAttribute="product" method="POST">
				...
				<div class="form-group row">
			  	...
			  	<div class="form-group row">
				    <div class="col-sm-10">
					    <input type="submit" value="Update General" class="btn btn-primary" />
			    	</div>
			  	</div>
